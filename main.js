...
for (let i=0; currencies.length>i; i++) {
    $('.add-currency-list').append(`
    <li data-currency=${currencies[i].abbreviation}>
        <img src=${currencies[i].flagURL} class="flag" alt="flag"><span>${currencies[i].abbreviation} - ${currencies[i].name}</span>
    </li>`);
}

var initialCurrenciesOnDisplay = ["USD", "EUR", "GBP", "JPY","RUB"];
